...
class Movie(models.Model):
    ...
    like = models.ManyToManyField('authentication.CustomUser', related_name='like', null=True, blank=True)
    dislike = models.ManyToManyField('authentication.CustomUser', related_name='dislike', null=True, blank=True)
